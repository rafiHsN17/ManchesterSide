...
<head>
    ...
    <style>
        ...
        .dropdown-menu {
            ...
            transition: opacity 0.1s ease, transform 0.1s ease, visibility 0s linear 1s;
            visibility: hidden;
        }
    ...
    <nav class="bg-white shadow-lg sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="fixtures.php" class="text-gray-700 hover:text-city-blue font-semibold transition <?php echo $current_page === 'fixtures.php' ? 'text-city-blue' : ''; ?>">
                        Jadwal & Hasil
                    </a>
        ...
        <div id="mobileMenu" class="hidden md:hidden bg-white border-t">
            <div class="px-4 py-3 space-y-2">
                ...
                <a href="fixtures.php" class="block py-2 text-gray-700 hover:text-city-blue font-semibold">Jadwal & Hasil</a>
