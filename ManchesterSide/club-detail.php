...
<!-- Tambahkan kode ini di club.php setelah Hero Section dan sebelum Quick Info Dropdown -->

<!-- Button Lihat Skuad Lengkap -->
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 mb-8">
    <div class="flex justify-center">
        <a href="club-full.php?team=<?php echo strtolower($team); ?>" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-<?php echo $team === 'CITY' ? 'city-blue' : 'united-red'; ?> to-<?php echo $team === 'CITY' ? 'city-navy' : 'red'; ?>-900 text-white font-bold rounded-xl hover:shadow-2xl transition transform hover:scale-105 text-lg">
            <span class="text-2xl mr-3">👥</span>
            Lihat Skuad Lengkap (Pemain & Staff)
