...
-- WITH REACTIONS FEATURE (NO COMMENTS)
-- ========================================
...
-- ========================================
-- 6. TABEL ARTICLES (WITH REACTION COLUMNS)
-- ========================================
...
-- ========================================
-- 9. TABEL MATCHES (Jadwal Pertandingan)
-- ========================================
...
-- ========================================
-- TRIGGERS FOR AUTOMATIC REACTION COUNTS
-- ========================================

DELIMITER //

-- Trigger when reaction is inserted
...
-- Trigger when reaction is updated
...
-- Trigger when reaction is deleted
...
-- ✅ 4 Staff members
-- ✅ 4 Sample articles (with reaction columns)
-- ✅ 6 Sample reactions
-- ✅ 4 Matches (2 scheduled, 2 finished)
-- ✅ Reaction system with auto-update triggers
-- ❌ NO COMMENTS TABLE (replaced with reactions)
-- ========================================

SELECT '✅ Database manchester_side created successfully!' AS Status;
SELECT '✅ Reactions feature enabled' AS Info;
SELECT '❌ Comments feature removed' AS Info;
