        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="profil-klub.php" class="text-gray-700 hover:text-city-blue font-semibold transition">Profil Klub</a>
                    ...
                    <a href="tentang-kami.php" class="text-city-blue font-bold">Tentang Kami</a>
                    <?php if ($current_user): ?>
