...
<head>
    ...
    <title>Semua Berita - Manchester Side</title>
    <meta name="description" content="Jelajahi semua berita terbaru Manchester City dan Manchester United di Manchester Side">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="news.php" class="text-city-blue font-bold">Berita</a>
                    <a href="club.php?team=city" class="text-gray-700 hover:text-city-blue font-semibold transition">Man City</a>
                    <a href="club.php?team=united" class="text-gray-700 hover:text-united-red font-semibold transition">Man United</a>
        ...
        <?php if ($club_filter !== 'all' || $category_filter !== 'all' || !empty($search) || $sort !== 'latest'): ?>
            <div class="mb-6 flex flex-wrap items-center gap-2">
                ...
                <?php if ($club_filter !== 'all'): ?>
                    <span class="px-3 py-1 bg-<?php echo $club_filter === 'city' ? 'city-blue' : 'united-red'; ?> text-white rounded-full text-sm font-semibold">
        ...
        <?php if ($articles_result->num_rows > 0): ?>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-12">
                <?php while ($article = $articles_result->fetch_assoc()): ?>
                    <a href="news-detail.php?slug=<?php echo $article['slug']; ?>" class="card-hover bg-white rounded-xl shadow-lg overflow-hidden group <?php echo $article['is_featured'] ? 'ring-2 ring-yellow-400' : ''; ?>">
                        ...
                        <div class="p-5">
                            ...
                            <h4 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-city-blue transition line-clamp-2">
