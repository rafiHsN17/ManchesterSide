            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute hidden group-hover:block bg-white shadow-xl rounded-lg mt-2 py-2 w-56">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-12">
            <?php foreach ($featured_articles as $article): ?>
                <a href="news-detail.php?slug=<?php echo $article['slug']; ?>" class="card-hover bg-white rounded-xl shadow-lg overflow-hidden group">
                    <div class="h-64 bg-gradient-to-br from-<?php echo $article['club_code'] === 'CITY' ? 'city-blue' : 'united-red'; ?>-500 to-<?php echo $article['club_code'] === 'CITY' ? 'city-navy' : 'red'; ?>-900 flex items-center justify-center p-8">
                        <img src="<?php echo $club_logos[$article['club_code']]; ?>" alt="<?php echo $article['club_name']; ?>" class="club-logo-medium">
                    </div>
                    <div class="p-6">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            <?php while ($article = $articles_result->fetch_assoc()): ?>
                <a href="news-detail.php?slug=<?php echo $article['slug']; ?>" class="card-hover bg-white rounded-xl shadow-lg overflow-hidden group">
                    <div class="h-48 bg-gradient-to-br from-<?php echo $article['club_code'] === 'CITY' ? 'city-blue' : ($article['club_code'] === 'UNITED' ? 'united-red' : 'gray'); ?>-500 to-<?php echo $article['club_code'] === 'CITY' ? 'city-navy' : ($article['club_code'] === 'UNITED' ? 'red' : 'gray'); ?>-900 flex items-center justify-center p-6">
                        <?php if ($article['club_code']): ?>
                            <img src="<?php echo $club_logos[$article['club_code']]; ?>" alt="<?php echo $article['club_name']; ?>" class="club-logo-small">
                        <?php else: ?>
            ...
            <div class="grid md:grid-cols-4 gap-8">
                <div>
                    <div class="flex items-center space-x-2 mb-4">
                        <div class="nav-logo-container">
                            <div class="nav-logo-wrapper" style="width: 24px; height: 24px;">
                                <img src="<?php echo $club_logos['CITY']; ?>" alt="Man City" style="width: 20px; height: 20px;">
                            </div>
                            <div class="nav-logo-wrapper" style="width: 24px; height: 24px; margin-left: -8px;">
                                <img src="<?php echo $club_logos['UNITED']; ?>" alt="Man United" style="width: 20px; height: 20px;">
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li>
                            <a href="club.php?team=city" class="flex items-center gap-2 hover:text-city-blue transition">
                                <img src="<?php echo $club_logos['CITY']; ?>" alt="Man City" class="w-4 h-4">
                                Manchester City
                            </a>
                        </li>
                        <li>
                            <a href="club.php?team=united" class="flex items-center gap-2 hover:text-united-red transition">
                                <img src="<?php echo $club_logos['UNITED']; ?>" alt="Man United" class="w-4 h-4">
                                Manchester United
                            </a>
                        </li>
                    </ul>
