<?php
/**
 * Manchester Side - User Profile Page
 */
...
// Total comments
$comment_result = $db->query("SELECT COUNT(*) as total FROM comments WHERE user_id = " . $user['id']);
$stats['comments'] = $comment_result->fetch_assoc()['total'];
                ...
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div class="px-6 pb-6">
                        ...
                        <div class="grid grid-cols-3 gap-4 py-4 border-t border-gray-200">
                            ...
                            <div class="text-center">
                                <p class="text-2xl font-bold text-gray-900"><?php echo $stats['comments']; ?></p>
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <?php if ($recent_comments->num_rows > 0): ?>
                        <div class="space-y-4">
                            <?php while ($comment = $recent_comments->fetch_assoc()): ?>
                                <div class="border-l-4 border-city-blue pl-4 py-3 bg-gray-50 rounded-r-lg">
                                    <p class="text-gray-700 mb-2"><?php echo truncateText($comment['comment'], 100); ?></p>
                                    <div class="flex items-center justify-between text-sm">
                                        <a href="news-detail.php?slug=<?php echo $comment['article_slug']; ?>" class="text-city-blue hover:underline font-semibold">
                                            On: <?php echo truncateText($comment['article_title'], 40); ?>
                                        </a>
                                        <span class="text-gray-500"><?php echo timeAgo($comment['created_at']); ?></span>
                                    </div>
                                </div>
                            <?php endwhile; ?>
                        </div>
                    <?php else: ?>
                        <div class="text-center py-12 text-gray-500">
                            ...
                            <p class="text-sm mt-2">Mulai berkomentar di artikel untuk melihat aktivitas Anda</p>
                        </div>
                    <?php endif; ?>
                </div>
