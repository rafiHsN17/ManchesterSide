    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="grid md:grid-cols-3 gap-8 items-center">
                ...
                <div class="text-center">
                    <div class="flex justify-center mb-4">
                        <img src="https://upload.wikimedia.org/wikipedia/en/e/eb/Manchester_City_FC_badge.svg" alt="Manchester City" class="w-32 h-32 object-contain">
                    </div>
                ...
                <div class="text-center">
                    <div class="flex justify-center mb-4">
                        <img src="https://upload.wikimedia.org/wikipedia/en/7/7a/Manchester_United_FC_crest.svg" alt="Manchester United" class="w-32 h-32 object-contain">
                    </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 mb-12">
            ...
            <div class="flex justify-between text-sm items-center">
                <span class="text-city-blue font-bold flex items-center gap-1">
                    <img src="https://upload.wikimedia.org/wikipedia/en/e/eb/Manchester_City_FC_badge.svg" alt="City" class="w-4 h-4 inline-block">
                    Man City: <?php echo round($city_win_percentage, 1); ?>%
                </span>
                <span class="text-gray-600 font-bold">⚪ Draw: <?php echo round($draw_percentage, 1); ?>%</span>
                <span class="text-united-red font-bold flex items-center gap-1">
                    <img src="https://upload.wikimedia.org/wikipedia/en/7/7a/Manchester_United_FC_crest.svg" alt="United" class="w-4 h-4 inline-block">
                    Man United: <?php echo round($united_win_percentage, 1); ?>%
                </span>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between p-3 bg-city-blue/10 rounded-lg">
                        <span class="font-semibold text-city-blue flex items-center gap-2">
                            <img src="https://upload.wikimedia.org/wikipedia/en/e/eb/Manchester_City_FC_badge.svg" alt="City" class="w-5 h-5">
                            Man City
                        </span>
                    ...
                    <div class="flex items-center justify-between p-3 bg-united-red/10 rounded-lg">
                        <span class="font-semibold text-united-red flex items-center gap-2">
                            <img src="https://upload.wikimedia.org/wikipedia/en/7/7a/Manchester_United_FC_crest.svg" alt="United" class="w-5 h-5">
                            Man United
                        </span>
                    ...
                    <?php foreach (array_slice($matches_array, 0, 10) as $match): ?>
                        ...
                        <div class="flex items-center justify-between p-4 <?php echo $winner_bg; ?> rounded-lg hover:shadow-md transition">
                            <div class="flex items-center space-x-4">
                                <img src="https://upload.wikimedia.org/wikipedia/en/e/eb/Manchester_City_FC_badge.svg" alt="City" class="w-8 h-8 object-contain">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <img src="https://upload.wikimedia.org/wikipedia/en/7/7a/Manchester_United_FC_crest.svg" alt="United" class="w-8 h-8 object-contain">
                            </div>
