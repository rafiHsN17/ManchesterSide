        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="favorites.php" class="text-city-blue font-bold">Favorit</a>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <?php foreach ($favorites_array as $article): ?>
                    <div class="card-hover bg-white rounded-xl shadow-lg overflow-hidden group relative">
                        ...
                        <!-- Favorited Badge -->
                        <div class="absolute top-4 left-4 z-10 px-3 py-1 bg-yellow-400 text-yellow-900 rounded-full text-xs font-bold shadow-lg">
                            ⭐ FAVORIT
                        </div>

                        <a href="news-detail.php?slug=<?php echo $article['slug']; ?>" class="block">
                            <!-- Image Placeholder -->
                            <div class="h-48 bg-gradient-to-br from-<?php echo $article['club_code'] === 'CITY' ? 'city-blue' : ($article['club_code'] === 'UNITED' ? 'united-red' : 'gray'); ?>-500 to-<?php echo $article['club_code'] === 'CITY' ? 'city-navy' : ($article['club_code'] === 'UNITED' ? 'red' : 'gray'); ?>-900 flex items-center justify-center text-white text-5xl">
                                <?php 
