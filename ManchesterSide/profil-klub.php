                                        ...
                                        <div class="flip-card-back">
                                            <div class="bg-gradient-to-br from-<?php echo $accent_color; ?>-500 to-<?php echo $accent_color === 'sky' ? 'blue' : 'red'; ?>-900 text-white rounded-2xl shadow-2xl h-full p-6 flex flex-col border-4 <?php echo $border_color; ?>">
                                                ...
                                                <div class="text-center mb-4">
                                                    ...
                                                    <p class="text-sm opacity-90"><?php echo $position; ?></p>
                                                </div>
                                                ...
                                                <div class="flex-1 space-y-2 text-sm">
                                                    ...
                                                    <?php if ($player['joined_date']): ?>
                                                        <div class="flex justify-between pb-2 border-b border-white/20">
                                                            <span>Bergabung:</span>
                                                            <span class="font-bold"><?php echo date('Y', strtotime($player['joined_date'])); ?></span>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden border-4 <?php echo $border_color; ?> h-full hover:shadow-3xl transition-shadow">
                                                ...
                                                <div class="h-20 bg-gradient-to-br from-<?php echo $team === 'CITY' ? 'sky-400' : 'red-500'; ?> to-<?php echo $team === 'CITY' ? 'blue-800' : 'red-900'; ?> flex items-center justify-center relative">
                                                    <div class="text-2xl font-black text-white relative z-10">
                                                        <?php echo strtoupper(substr($role, 0, 3)); ?>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="flip-card-back">
                                            <div class="bg-gradient-to-br from-<?php echo $accent_color; ?>-500 to-<?php echo $accent_color === 'sky' ? 'blue' : 'red'; ?>-900 text-white rounded-2xl shadow-2xl h-full p-6 flex flex-col border-4 <?php echo $border_color; ?>">
                                                ...
                                                <div class="text-center mb-4">
                                                    ...
                                                    <h3 class="text-xl font-bold mb-1"><?php echo $staff['name']; ?></h3>
                                                    <p class="text-sm opacity-90"><?php echo $staff['role']; ?></p>
                                                </div>
                                                    ...
                                                    <?php if ($staff['achievements']): ?>
                                                        <div class="pt-2">
                                                            ...
                                                            <p class="text-xs opacity-90 leading-relaxed">
                                                                <?php echo nl2br(htmlspecialchars($staff['achievements'])); ?>
                                                            </p>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
