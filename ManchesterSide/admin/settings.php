                        ...
                        <form method="POST" action="" class="space-y-6">
                            ...
                            <div class="bg-white rounded-xl shadow-lg p-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <!-- Site Description -->
                                    <div>
                                        <label for="site_description" class="block text-sm font-bold text-gray-700 mb-2">
                                            Deskripsi
                                        </label>
                                        <textarea 
                                            id="site_description" 
                                        ...
                                        ><?php echo htmlspecialchars($current_settings['site_description'] ?? ''); ?></textarea>
                                    </div>
                                    ...
                                    <div>
                                        <label class="flex items-center space-x-3 cursor-pointer">
                                            <input 
                                                ...
                                                name="allow_comments" 
                                                value="1"
                                                <?php echo ($current_settings['allow_comments'] ?? '1') == '1' ? 'checked' : ''; ?>
                                                class="w-5 h-5 text-city-blue border-gray-300 rounded focus:ring-city-blue"
                                            >
                                            <div>
                                                <span class="font-semibold text-gray-900">Izinkan Komentar</span>
                                                <p class="text-xs text-gray-500">User dapat memberikan komentar di artikel</p>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                                        <label class="flex items-center space-x-3 cursor-pointer">
                                            ...
                                            >
                                            <div>
                                                <span class="font-semibold text-yellow-900">Mode Maintenance</span>
                                                <p class="text-xs text-yellow-700">Website tidak dapat diakses oleh user (admin tetap bisa akses)</p>
                                            </div>
                                        </label>
                                    </div>
                                </div>
