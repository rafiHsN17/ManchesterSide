...
// Pending comments
$result = $db->query("SELECT COUNT(*) as total FROM comments WHERE is_approved = 0");
...
// Recent comments
$recent_comments = $db->query("SELECT 
    c.id, c.comment, c.is_approved, c.created_at,
    u.username,
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="comments/" class="flex items-center space-x-3 px-4 py-3 hover:bg-gray-800 rounded-lg transition">
                    ...
                    <?php if ($stats['pending_comments'] > 0): ?>
                        <span class="ml-auto bg-united-red text-white text-xs px-2 py-1 rounded-full">
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500">
                        <div class="flex items-center justify-between mb-4">
                            <div class="text-4xl">💬</div>
                            <div class="text-right">
                                <p class="text-3xl font-bold text-gray-900"><?php echo $stats['total_comments']; ?></p>
                        ...
                        <?php if ($stats['pending_comments'] > 0): ?>
                            <div class="text-xs bg-yellow-100 text-yellow-800 px-2 py-1 rounded font-semibold">
                                ⚠️ <?php echo $stats['pending_comments']; ?> menunggu approval
                            </div>
                        <?php else: ?>
                            <div class="text-xs text-green-600 font-semibold">
                                ✅ Semua komentar sudah di-review
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-gradient-to-br from-city-blue to-city-navy text-white rounded-xl shadow-xl p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                <h3 class="text-2xl font-bold">🔵 Manchester City</h3>
                    ...
                    <div class="bg-gradient-to-br from-united-red to-red-900 text-white rounded-xl shadow-xl p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                <h3 class="text-2xl font-bold">🔴 Manchester United</h3>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <a href="articles/" class="text-sm text-city-blue hover:underline font-semibold">
                                Lihat Semua →
                            </a>
                        </div>
                        <div class="space-y-3">
                            <?php while ($article = $recent_articles->fetch_assoc()): ?>
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                                    <div class="flex-1">
                                        <a href="articles/edit.php?id=<?php echo $article['id']; ?>" class="font-semibold text-gray-900 hover:text-city-blue">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-xl font-bold text-gray-900">💬 Komentar Terbaru</h3>
                            <a href="comments/" class="text-sm text-city-blue hover:underline font-semibold">
                                Lihat Semua →
                            </a>
                        </div>
                        <div class="space-y-3">
                            <?php while ($comment = $recent_comments->fetch_assoc()): ?>
                                <div class="p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                                    <div class="flex items-center justify-between mb-2">
                                        <span class="font-semibold text-gray-900">@<?php echo $comment['username']; ?></span>
                                        <?php if ($comment['is_approved']): ?>
                                            <span class="px-2 py-0.5 bg-green-100 text-green-800 text-xs rounded font-semibold">Approved</span>
                                        <?php else: ?>
                                            <span class="px-2 py-0.5 bg-yellow-100 text-yellow-800 text-xs rounded font-semibold">Pending</span>
                                        <?php endif; ?>
                                    </div>
                                    <p class="text-sm text-gray-700 mb-2"><?php echo truncateText($comment['comment'], 80); ?></p>
                                    <div class="flex items-center justify-between text-xs text-gray-500">
                                        <a href="../news-detail.php?slug=<?php echo $comment['article_slug']; ?>" class="hover:text-city-blue">
                                            On: <?php echo truncateText($comment['article_title'], 30); ?>
                                        </a>
                ...
                <div class="mt-8 bg-gradient-to-r from-city-blue to-united-red rounded-xl shadow-xl p-6 text-white">
                    ...
                    <div class="grid md:grid-cols-4 gap-4">
                        <a href="articles/create.php" class="bg-white/20 hover:bg-white/30 rounded-lg p-4 text-center transition backdrop-blur-sm">
                        ...
                        <a href="comments/" class="bg-white/20 hover:bg-white/30 rounded-lg p-4 text-center transition backdrop-blur-sm">
                            <div class="text-3xl mb-2">💬</div>
                            <p class="font-semibold">Review Komentar</p>
                        </a>
