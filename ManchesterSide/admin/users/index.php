            ...
            <div class="p-6">
                ...
                <div class="grid md:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-gradient-to-br from-city-blue to-city-navy text-white rounded-xl shadow-lg p-6">
                        ...
                        <p class="font-semibold">City Fans</p>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-united-red to-red-900 text-white rounded-xl shadow-lg p-6">
                        ...
                        <p class="font-semibold">United Fans</p>
                    </div>
                </div>
                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-6 py-4">
                                            <?php if ($user['favorite_team']): ?>
                                                <span class="px-3 py-1 bg-<?php echo $user['favorite_team'] === 'CITY' ? 'city-blue' : 'united-red'; ?> text-white rounded-full text-xs font-bold">
                                                    <?php echo $user['favorite_team'] === 'CITY' ? '🔵 CITY' : '🔴 UNITED'; ?>
                                                </span>
                                            <?php else: ?>
