...
<div class="p-8">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">👥 Kelola Pemain</h1>
            <p class="text-gray-600 mt-1">Manage data pemain Manchester City & United</p>
        </div>
                    ...
                    <div class="flip-card" onclick="this.classList.toggle('flipped')">
                        ...
                        <div class="flip-card-front">
                            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden border-4 <?php echo $border_color; ?> h-full">
                                ...
                                <div class="h-20 bg-gradient-to-br from-<?php echo $player['club_code'] === 'CITY' ? 'sky-400' : 'red-500'; ?> to-<?php echo $player['club_code'] === 'CITY' ? 'blue-800' : 'red-900'; ?> flex items-center justify-center relative">
                                    <div class="text-6xl font-black text-white/30 absolute"><?php echo $player['jersey_number']; ?></div>
                                    <div class="text-4xl font-black text-white relative z-10">#<?php echo $player['jersey_number']; ?></div>
                                </div>
                        ...
                        <div class="flip-card-back">
                            <div class="bg-gradient-to-br from-<?php echo $accent_color; ?>-500 to-<?php echo $accent_color === 'sky' ? 'blue' : 'red'; ?>-900 text-white h-full p-6 flex flex-col">
                                ...
                                <div class="flex-1 space-y-3 text-sm">
                                    ...
                                    <div class="flex justify-between pb-2 border-b border-white/20">
                                        <span>Status:</span>
                                        <span class="font-bold"><?php echo $player['is_active'] ? '✅ Aktif' : '❌ Nonaktif'; ?></span>
                                    </div>
                                </div>
