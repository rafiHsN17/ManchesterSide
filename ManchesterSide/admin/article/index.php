                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-6 py-4">
                                            <?php if ($article['club_code']): ?>
                                                <span class="px-3 py-1 bg-<?php echo $article['club_code'] === 'CITY' ? 'city-blue' : 'united-red'; ?> text-white rounded-full text-xs font-bold">
                                                    <?php echo $article['club_code'] === 'CITY' ? '🔵' : '🔴'; ?> <?php echo $article['club_code']; ?>
                                                </span>
                                            <?php else: ?>
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex items-center justify-end space-x-2">
                                                <a href="../../news-detail.php?slug=<?php echo $article['slug']; ?>" target="_blank" class="px-3 py-1 bg-blue-100 text-blue-800 rounded-lg text-xs font-semibold hover:bg-blue-200 transition" title="View">
                                                    👁️
                                                </a>
