                                ...
                                <div class="flip-card" onclick="this.classList.toggle('flipped')">
                                    ...
                                    <div class="flip-card-front">
                                        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden border-4 <?php echo $border_color; ?> h-full">
                                            <!-- Header -->
                                            <div class="h-20 bg-gradient-to-br from-<?php echo $staff['club_code'] === 'CITY' ? 'sky-400' : 'red-500'; ?> to-<?php echo $staff['club_code'] === 'CITY' ? 'blue-800' : 'red-900'; ?> flex items-center justify-center relative">
                                            ...
                                            <div class="flex justify-center -mt-12 mb-4 px-4">
                                                <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-2xl bg-gray-100">
                                                    <img 
                                                        ...
                                                        onerror="this.src='<?php echo getStaffPhoto('', $staff['name'], $staff['club_code']); ?>'"
                                                    >
                                                </div>
                                            </div>
