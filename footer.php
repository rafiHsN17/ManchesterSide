        ...
        <div class="grid md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-3 text-gray-400">
                    <li>
                        <a href="club.php?team=city" class="flex items-center gap-2 hover:text-city-blue transition group">
                            <img src="<?php echo $club_logos['CITY']; ?>" alt="Man City" class="w-5 h-5 group-hover:scale-110 transition">
                            <span>Manchester City</span>
                        </a>
                    </li>
                    <li>
                        <a href="club.php?team=united" class="flex items-center gap-2 hover:text-united-red transition group">
                    ...
                    <li class="pt-2 border-t border-gray-700">
                        <a href="profil-klub.php?team=city" class="text-sm hover:text-city-blue transition">Profil Lengkap City</a>
                    </li>
                    <li>
                        <a href="profil-klub.php?team=united" class="text-sm hover:text-united-red transition">Profil Lengkap United</a>
                    </li>
                </ul>
            </div>
