        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                >
                    ...
                    <option value="Pelatih Kepala" <?php echo ($staff['role'] === 'Pelatih Kepala') ? 'selected' : ''; ?>>Pelatih Kepala</option>
                    <option value="Asisten Pelatih" <?php echo ($staff['role'] === 'Asisten Pelatih') ? 'selected' : ''; ?>>Asisten Pelatih</option>
                    <option value="Pelatih Kiper" <?php echo ($staff['role'] === 'Pelatih Kiper') ? 'selected' : ''; ?>>Pelatih Kiper</option>
                    <option value="Pelatih Fisik" <?php echo ($staff['role'] === 'Pelatih Fisik') ? 'selected' : ''; ?>>Pelatih Fisik</option>
                    <option value="Direktur Teknik" <?php echo ($staff['role'] === 'Direktur Teknik') ? 'selected' : ''; ?>>Direktur Teknik</option>
                </select>
            </div>
