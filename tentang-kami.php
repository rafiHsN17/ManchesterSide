    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition">
                        ...
                        <div class="card-padding p-6 md:p-8">
                            ...
                            <div class="flex justify-center -mt-16 md:-mt-20 mb-4 md:mb-6">
                                ...
                                $custom_photo_path = "uploads/profiles/admin_" . strtolower(str_replace(' ', '_', $admin['name'])) . ".jpg";
                            ...
                            <div class="flex justify-center gap-2 md:gap-3 pt-4 md:pt-6 border-t border-gray-200">
                                <a href="mailto:<?php echo $admin['social']['email']; ?>" class="w-9 h-9 md:w-10 md:h-10 bg-gray-100 hover:bg-blue-500 hover:text-white rounded-full flex items-center justify-center transition text-sm md:text-base">
                                    <span>📧</span>
                                </a>
                                <a href="<?php echo $admin['social']['twitter']; ?>" class="w-9 h-9 md:w-10 md:h-10 bg-gray-100 hover:bg-sky-500 hover:text-white rounded-full flex items-center justify-center transition text-sm md:text-base">
                                    <span>🐦</span>
                                </a>
                                <a href="<?php echo $admin['social']['linkedin']; ?>" class="w-9 h-9 md:w-10 md:h-10 bg-gray-100 hover:bg-blue-700 hover:text-white rounded-full flex items-center justify-center transition text-sm md:text-base">
                                    <span>💼</span>
                                </a>
                            </div>
                        </div>
        ...
        <div class="mb-8 md:mb-16">
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                ...
                <div class="bg-white rounded-xl shadow-lg p-5 md:p-6 text-center hover:shadow-xl transition">
                    <div class="text-4xl md:text-5xl mb-3 md:mb-4">📱</div>
                    <h3 class="text-lg md:text-xl font-bold text-gray-900 mb-2 md:mb-3">Mobile Friendly</h3>
                    <p class="text-sm md:text-base text-gray-600">Akses dari perangkat apapun dengan tampilan responsif</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-city-blue to-united-red rounded-2xl shadow-2xl p-6 md:p-12 text-white text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
                <a href="mailto:info@manchesterside.com" class="px-6 md:px-8 py-3 md:py-4 bg-white text-gray-900 font-bold rounded-lg hover:bg-gray-100 transition text-sm md:text-base">
                    📧 Hubungi Kami
                </a>
